...
//                 disabled={loading} // Disable button when loading
//                 sx={{
//                   bgcolor: loading ? "#1976d2" : undefined, // Set blue background when loading
//                   '&:hover': {
//                     bgcolor: loading ? "#1976d2" : undefined, // Set blue background on hover when loading
//                   },
//                   '&:focus': {
//                     bgcolor: loading ? "#1976d2" : undefined, // Set blue background on focus when loading
//                   },
//                 }}
//               >
//                 {loading ? <CircularProgress size={24} color="inherit" /> : "Sign Up"}
