  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ width: '80%', height: '200px' }}>
          <TextField
            variant="outlined"
            margin="normal"
            required
        ...
        <Typography variant="body2" sx={{ mb: 7 , mt: -7, ml:-4 }}>
          Remember your password? 
          <Link to="/login" style={{ color: 'blue',marginLeft: '4px' }}>Log in</Link>
        </Typography>
      </Box>
    </Container>
  );
