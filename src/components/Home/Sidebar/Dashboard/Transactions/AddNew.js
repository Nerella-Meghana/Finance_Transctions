...
//             },
//           };
//           const response = await finappaxios.get(`/api/transactions/${editId}`, config);
...
//       let response;
//       if (editId) {
//         response = await finappaxios.put(`/api/transactions/${editId}`, formData, config);
//       } else {
//         response = await finappaxios.post('/api/transactions', formData, config);
//       }
//       if (response.status === 200 || response.status === 201) {
//         setPopupMessage(editId ? 'Transaction updated successfully' : 'Transaction added successfully');
//         setTimeout(() => {
...
//   return (
//     <div>
//       <h1 className="text-2xl font-semibold mb-6 text-left text-indigo-900">{editId ? 'Edit Transaction' : 'Add Transaction'}</h1>
...
// src/components/Home/Sidebar/Dashboard/Transactions/AddNew.js
...
//       <div className="max-w-xl w-full mx-auto p-8 bg-white shadow-lg rounded-3xl h-100%">
...
//       <div className="max-w-xl w-full mx-auto p-8 bg-white shadow-lg rounded-3xl">
//         <h1 className="text-2xl font-semibold mb-6 text-left text-indigo-900">
//           {editId || id ? 'Edit Transaction' : 'Add Transaction'}
//         </h1>
//         <form onSubmit={handleSubmit} className="space-y-6">
...
//             </div>
//           </div>
//           <div className="flex justify-end space-x-4 mt-6"> {/* Adjusted spacing */}
//             <button
//               type="button"
//               onClick={onClose}
//               className="px-4 py-2 border border-gray-300 rounded-md text-gray-700"
      ...
      <div className="max-w-xl w-full mx-auto p-8 bg-white rounded-3xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-md font-medium text-gray-700 pb-2 text-black">Status</label>
              <select
                name="status"
